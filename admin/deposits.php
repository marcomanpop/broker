		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<div class="row g-3 mb-4 align-items-center justify-content-between">
					<div class="col-auto">
						<h1 class="app-page-title mb-0">Deposit History</h1>
					</div>
				</div>
								...
								<div class="table-responsive">
									<table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
													...
													<tr>
														...
														<td class="cell">
															<?php if ($transaction['status'] == 'pending') : ?>
																<form method="POST" action="assets/php/process_deposits.php" class="d-inline">
											...
											<?php else : ?>
												<tr>
													<td class="cell" colspan="6">No deposits found.</td>
												</tr>
											<?php endif; ?>
										</tbody>
									</table>
