  ...
  <div class="app-wrapper">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
          <div class="col-auto">
            <h1 class="app-page-title mb-0">Withdraw History</h1>
          </div>
        </div>
    ...
    <thead>
        <tr>
            ...
            <?php if (!empty($transactions) && array_filter($transactions, fn($t) => $t['method'] === 'Bank-Transfer')) : ?>
                <th class="cell">Bank Details</th>
            <?php endif; ?>
            <th class="cell">Status</th>
            <th class="cell">Action</th> <!-- New Action Column -->
        </tr>
    </thead>
    <tbody>
        <?php if (!empty($transactions)) : ?>
            ...
            <?php foreach ($transactions as $transaction) : ?>
                <tr>
                    ...
                    <!-- Display Bank Details only if the method is Bank-Transfer -->
                    <?php if ($transaction['method'] === 'Bank-Transfer') : ?>
                        <td class="cell">
                            <strong>Bank Name:</strong> <?php echo htmlspecialchars($transaction['bank_name']); ?><br>
                            <strong>Account Name:</strong> <?php echo htmlspecialchars($transaction['account_name']); ?><br>
                            <strong>Account Number:</strong> <?php echo htmlspecialchars($transaction['account_number']); ?>
                        </td>
                    <?php elseif (!empty(array_filter($transactions, fn($t) => $t['method'] === 'Bank-Transfer'))) : ?>
                        <td class="cell"><?php echo htmlspecialchars($transaction['wallet_address']); ?></td> <!-- Empty cell to maintain table alignment -->
                    <?php endif; ?>
                    ...
                    <td class="cell">
                        <?php if ($transaction['status'] == 'pending') : ?>
                            <form method="POST" action="assets/php/process_withdrawal.php" class="d-inline">
        ...
        <?php else : ?>
            <tr>
                <td class="cell" colspan="7">No transactions found.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
