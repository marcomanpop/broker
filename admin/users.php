                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cell">Verification Status</th>
                                        ...
                                        <tbody>
                                            <?php if (count($users) > 0) : ?>
                                                ...
                                                <?php foreach ($users as $user) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="cell"><?= htmlspecialchars($user['username']); ?></td>
                                                        <td class="cell"><?= htmlspecialchars($user['email']); ?></td>
                                                        <td class="cell"><?= htmlspecialchars($user['account_type']); ?></td>
                                                        <td class="cell"><?= htmlspecialchars($user['currency'] . number_format($user['balance'], 2)); ?></td>
                                                        <td class="cell">
                                                            <span class="badge bg-<?php echo ($user['verified'] == 1) ? 'success' : 'danger'; ?>">
                                                                <?php echo ($user['verified'] == 1) ? 'Verified' : 'Unverified'; ?>
                                                            </span>
                                                        </td>
                                                        <td class="cell">
                                                            <a href="edit_user.php?user_id=<?= $user['id']; ?>" class="btn btn-sm btn-info">
                                                                Edit User
                                                            </a>
                                                        </td>
                                                    </tr>
                                            ...
                                            <?php else : ?>
                                                <tr>
                                                    <td class="cell" colspan="6">No users found.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
