...
// Retrieve all data from the subscriptions table
$query = "SELECT 
        ...
        ORDER BY subscriptions.subscribed_at DESC";
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<div class="row g-3 mb-4 align-items-center justify-content-between">
					<div class="col-auto">
						<h1 class="app-page-title mb-0">Signal History</h1>
					</div>
				</div>
                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            <?php if (!empty($subscriptions)) : ?>
                                                <?php $i = count($subscriptions); ?>
                                                <?php foreach ($subscriptions as $subscription) : ?>
                                                    <tr>
                                                        <td class="cell"><?php echo $i--; ?></td>
                                                        <td class="cell"><?php echo htmlspecialchars($subscription['username']); ?></td>
                                                        <td class="cell"><?php echo htmlspecialchars($subscription['package_name']); ?></td>
                                                        <td class="cell">$<?php echo number_format($subscription['price'], 2); ?></td>
                                                        <td class="cell"><?php echo htmlspecialchars($subscription['duration']); ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else : ?>
                                                <tr>
                                                    <td class="cell text-center" colspan="7">No subscriptions found.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
