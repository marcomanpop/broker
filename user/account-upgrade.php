...
<body style="background-size:cover;
		...
		<div class=" justify-content-between  " style="margin-top:-35px;">
			...
			<div class="content  ">
				...
				<div style="margin-top:12px;">
					...
					<p align="center" class="text-uppercase">Account Upgrade</p>
				</div>
				...
				<div class="modal-body">
					...
					<form action="assets/php/submit_request.php" method="post" enctype="multipart/form-data">
						<!-- <div class="form-group mt-3">
							<label for="upgraderequest" class="label a1 mb-2">Upgrade Plans</label>
							<select id="upgraderequest" name="upgraderequest" class="form-control c" required>
								<option value="" style="color:#fff;">---Select Plan---</option>
								<option value="" style="color:#fff;">Basic</option>
								<option value="" style="color:#fff;">---Select Plan---</option>
								<option value="" style="color:#fff;">---Select Plan---</option>
							</select>
						</div> -->
						...
						<input type="hidden" name="transaction_type" id="transaction_type" value="upgrade">
	...
	<!-- <script type="text/javascript" src="assets/js/accountupgrade.js"></script> -->
